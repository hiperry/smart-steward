...
//                },
            ...
            saveWin.show(this,function(){
                ...
                Ext.getCmp('cityId').getStore().load({
                        params : {provinceId : record.get('provinceId')},
                        callback:function(){
                            Ext.getCmp('cityId').setValue(record.get('cityId'));
                        }

                });

                if(record.get('areaId')){
                    Ext.getCmp('areaId').getStore().load({
                        params : {cityId : record.get('cityId')},
                        callback:function(){
                            Ext.getCmp('areaId').setValue(record.get('areaId'));
                        }
