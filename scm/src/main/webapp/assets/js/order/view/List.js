...
Ext.define('Supplier.view.List', {
    ...
    viewConfig: {
        ...
        getRowClass : function(record,rowIndex,rowParams,store){
            var obj= '';
            if(record.get('hasPostFee')){
                obj= 'x-grid-record-red';

            }

            if(record.get('refunding') != '正常'){//是否有未分配货款
                obj =  'x-grid-record-green';
            }

            if( record.get('orderStatus').name == 'INVALID'){
                obj =  'x-grid-record-blue';
            }
    ...
    initComponent: function () {
        ...
        this.tbar = {
            items: [
                ...
                '->',
                { xtype: 'displayfield', itemId: 'goodsFee', value: '0', fieldLabel: '总货款', labelWidth: 45,hidden:true,},
                { xtype: 'displayfield', itemId: 'orderConut', value: '0', fieldLabel: '订单总条数', labelWidth: 70,}
            ]
        };
        ...
        this.columns = [
            ...
            {text: '整单平台优惠金额', dataIndex: 'sharedDiscountFee', sortable: true, width: 120, xtype: 'numbercolumn', format: '0.00'},
            {text: '整单店铺优惠金额', dataIndex: 'selfSharedDiscountFee', sortable: true, width: 120, xtype: 'numbercolumn', format: '0.00'},
...
//                },
            ...
            {text: '支付宝账号', dataIndex: 'buyerAlipayNo', width: 160, sortable: true,
                renderer:function(value){
                    if(value == null){
                        return '';
                    }else{
