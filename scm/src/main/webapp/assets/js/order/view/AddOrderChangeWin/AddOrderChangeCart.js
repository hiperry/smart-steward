...
Ext.define('Supplier.view.AddOrderChangeWin.AddOrderChangeCart', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.AddOrderChangeCart',
    region: 'south',
    height: 120,
    id: 'AddOrderChangeCart',
    forceFit: false,
    split: true,
    store: 'AddOrderChangeWin.GoodCart',
            ...
            {text: '订单类型', dataIndex: 'orderItemType',
                editor: new Ext.form.ComboBox({
                    ...
                    store: Ext.create('Ext.data.Store',{
                        ...
                        data:[
//                            {value: 'PRODUCT',orderItemType:'正常'},
//                            {value: 'GIFT',orderItemType:'赠品'},
//                            {value: 'REPLENISHMENT',orderItemType:'追加产品'},
                            {value: 'EXCHANGE_AFTERSALE',orderItemType:'售后换货'},
                        ]
                    }),
                    queryMode: 'local',
                    triggerAction: 'all',
