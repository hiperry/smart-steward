...
Ext.define('Supplier.view.Item', {
    ...
    columns: [
        ...
        { text: '平台优惠金额', dataIndex: 'sharedDiscountFee',sortable: true, width: 120, xtype: 'numbercolumn', format: '0.00'},
        {text: '店铺优惠金额', dataIndex: 'selfSharedDiscountFee', sortable: true, width: 120, xtype: 'numbercolumn', format: '0.00'},
