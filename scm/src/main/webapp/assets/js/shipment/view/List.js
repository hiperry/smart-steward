    ...
    initComponent: function () {
        ...
        this.tbar = {
            items: [
                ...
                { xtype: 'button', text: '顺丰[热敏]', iconCls: 'icon-edit', belong: 'CONFIRMED', itemId: 'sfBtn' },
...
//            },
            ...
            {text: '整单平台优惠金额', dataIndex: 'sharedDiscountFee', sortable: true, width: 140, xtype: 'numbercolumn', format: '0.00'},
            {text: '整单店铺优惠金额', dataIndex: 'selfSharedDiscountFee', sortable: true, width: 140, xtype: 'numbercolumn', format: '0.00'},
