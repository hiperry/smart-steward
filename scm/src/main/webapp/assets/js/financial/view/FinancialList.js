...
//                        }
                ...
                },
                {
                    ...
                    items: [
                        Ext.create('Go.form.field.DateTime', {
                            fieldLabel: '开始日期',
                            value: new Date(new Date().setHours(0, 0, 0, 0) - 60 * 60 * 24 * 1000 * 7),
                            name: 'startTime',
                            itemId: 'startPayTime',
                            format: 'Y-m-d H:i:s',
                            margin: '0 5 5 0',
                ...
                },
                {
                    items: [
                        Ext.create('Go.form.field.DateTime', {
                            fieldLabel: '结束日期',
                            value: new Date(new Date().setHours(23, 59, 59, 59)),
                            name: 'endTime',
                            id: 'endPayTime',
                            format: 'Y-m-d H:i:s',
                            margin: '0 5 5 0',
        ...
        var FinancePanel = Ext.create('Ext.panel.Panel', {
            title: '财务导出使用说明',
            width: 200,
            html: '<p style="text-indent:22px;">1.该模块只能导出8月1日0点之后的财务数据,如果要导出8月份之前的发货数据,请使用发货管理的导出功能.</p><p style="text-indent:22px;">2.对账数据中,暂时只有平台类型为天猫和京东的对账金额是准确的,其他平台因为还没有对接,单价为操作人员下单的时候手动输入的.</p><p style="text-indent:22px;">3.导出的报表中,货款一列为与品牌商结算的货款.货款计算公式为:货款 = 促销价*数量 - 店铺分摊优惠 + 分摊邮费 - 线上账面款金额.</p><p style="text-indent:22px;">4.关于报表的详细说明请查看操作手册.</p>',
            region: 'center',
            itemId: 'FinancePanel',
            id: 'FinancePanel',
        });
