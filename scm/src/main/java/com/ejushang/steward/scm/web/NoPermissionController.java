...
//    }
    ...
    @RequestMapping("/np/order/update_valid_and_delete")
    @ResponseBody
    public String updateValidAndDelete() throws Exception {
        updateDataService.deleteOrder(Lists.newArrayList(34416, 34758, 35234, 37763));
        updateDataService.updateOrderItemValidToFalse();
        updateDataService.updateRefundTime();
        return "success";
    }

    @RequestMapping("/np/order/reset_discount")
    @ResponseBody
    public String fixOrder() throws Exception {
