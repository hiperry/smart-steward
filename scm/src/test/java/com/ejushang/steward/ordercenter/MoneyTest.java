...
//        assertThat(money.getCent(), is(12337L));
    ...
    public void testOppositeCorrect() {
        assertThat(Money.valueOf(0.12d).opposite().getAmount(), is(-0.12d));
        assertThat(Money.valueOf(12d).opposite().getAmount(), is(-12d));
        assertThat(Money.valueOf(12d).opposite().getAmount(), is(-12d));
        assertThat(Money.valueOf(1.2d).opposite().getAmount(), is(-1.2d));
        assertThat(Money.valueOf(12d).opposite().getAmount(), is(-12d));
    }
