...
//        generalDAO.saveOrUpdate(order);
    ...
    public void testSearch() throws InterruptedException {
        ...
        ErrorInfo errorInfo = generalDAO.get(ErrorInfo.class, 1097);
        System.out.println("before: " + errorInfo.getTitle());
    ...
    public void testSearch2() throws InterruptedException {
        ...
        generalDAO.saveOrUpdate(errorInfo);
        System.out.println("after: " + title);
        String hql = "select ei from ErrorInfo ei where title != ?";
        List results = generalDAO.query(hql, null, "'123'");
