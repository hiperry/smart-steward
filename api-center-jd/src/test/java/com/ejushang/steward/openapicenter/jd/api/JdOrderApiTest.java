...
public class JdOrderApiTest {
    ...
    public void testOrderSearch() throws Exception {
        ...
        Map<String,Object> argsMap = new HashMap<String, Object>();
        // 订单抓取开始时间
        argsMap.put(ConstantJingDong.START_DATE,"2014-04-03 20:05:00");
        // 订单抓取结束时间
        argsMap.put(ConstantJingDong.END_DATE,"2014-04-14 20:06:00");
        // 查询时间类型
        argsMap.put(ConstantJingDong.DATETYPE,ConstantJingDong.JD_DATE_TYPE);
        // 查询订单类型
        argsMap.put(ConstantJingDong.ORDER_STATE, "FINISHED_L");
        // 查询第几页
        argsMap.put(ConstantJingDong.PAGE,"1");
        // 查询的每页最大条数
        argsMap.put(ConstantJingDong.PAGE_SIZE,ConstantJingDong.JD_FETCH_ORDER_PAGE_SIZE);

        JdOrderApi orderApi = new JdOrderApi("06dd8e19-5a18-4319-a4c5-bfa731a7b597");
