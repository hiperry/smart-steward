...
public class JdProductInvoke extends AbstractProductInvoke {
    ...
    public void downSyncProductInfo(String outerProductNo, String sku, ProductPlatform productPlatform) throws ApiInvokeException {
        ...
        copyProperties(item, productPlatform);
    }
     ...
     */
    private void copyProperties(Sku sku, ProductPlatform productPlatform) {
        productPlatform.setPrice(Money.valueOf(sku.getMarketPrice()));
        productPlatform.setStorageNum((int) sku.getStockNum());
        productPlatform.setPlatformUrl(generateURL(sku.getSkuId()));
        //TODO　促销价
    }
    ...
    public void productListing(String outerProductNo, String sku) throws ApiInvokeException {
        ...
        try {
            if (isOnSale(ware)) {
                updateProductPlatformStorage(outerProductNo, sku, null);//如果商品在买，则把库存更新即上架了
            } else {
    ...
    public void updateProductPlatformStorage(String outerProductNo, String sku, ProductPlatform productPlatform) throws ApiInvokeException {
        ...
        try {
            ...
            assertSuccess(wareSkuStockUpdateResponse);
            if (!storageNum.equals(productPlatform.getStorageNum())) {
