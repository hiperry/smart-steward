...
public class OriginalOrder implements EntityClass<Integer>{
    ...
    /** 自身店铺优惠金额 */
    private Money selfDiscountFee = Money.valueOf(0);
    ...
    @javax.persistence.Column(name = "self_discount_fee")
    public Money getSelfDiscountFee() {
        return selfDiscountFee;
    }

    public void setSelfDiscountFee(Money selfDiscountFee) {
        this.selfDiscountFee = selfDiscountFee;
    }
