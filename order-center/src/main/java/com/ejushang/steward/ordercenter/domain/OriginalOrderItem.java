...
public class OriginalOrderItem implements EntityClass<Integer>{
    ...
    /** 自身店铺优惠分摊 */
    private Money selfPartMjzDiscount = Money.valueOf(0);
    ...
    @javax.persistence.Column(name = "self_part_mjz_discount")
    public Money getSelfPartMjzDiscount() {
        return selfPartMjzDiscount;
    }

    public void setSelfPartMjzDiscount(Money selfPartMjzDiscount) {
        this.selfPartMjzDiscount = selfPartMjzDiscount;
    }
